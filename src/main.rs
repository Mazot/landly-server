...
#[openapi(
    ...
    paths(
        ...
        app::features::common::controllers::fetch_country_detail,
        ...
        app::features::organisation::controllers::search_organisations,
        ...
        app::features::user::controllers::fetch_me,
        app::features::user::controllers::update_me,
        app::features::user::controllers::update_notification_settings,
        ...
        app::features::corridor::controllers::create_corridor,
        app::features::corridor::controllers::list_corridors,
        app::features::corridor::controllers::set_default_corridor,
        app::features::corridor::controllers::delete_corridor,
        app::features::corridor::controllers::fetch_corridor_stats,
    ...
    components(
        schemas(
            ...
            app::features::common::presenters::CountryDetailContent,
            app::features::common::presenters::CountryPlacesByType,
            ...
            app::features::organisation::requests::SearchOrganisationsQueryRequest,
            ...
            app::features::user::requests::UpdateProfileRequest,
            app::features::user::requests::UpdateNotificationSettingsRequest,
            ...
            app::features::user::presenters::UserProfileContent,
            app::features::user::presenters::UserProfileStatsContent,
            app::features::user::presenters::UserLanguagesContent,
            app::features::corridor::requests::CreateCorridorRequest,
            app::features::corridor::presenters::CorridorContent,
            app::features::corridor::presenters::MultipleCorridorsResponse,
            app::features::corridor::presenters::CorridorStatsContent,
            app::features::corridor::presenters::CorridorTypeCount,
    ...
    tags(
        ...
        (name = "Corridor", description = "User corridor (from → to country) endpoints"),
